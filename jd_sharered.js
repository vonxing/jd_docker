...
活动入口：https://story.m.jd.com/babelDiy/Zeus/2HxATPMr9wQsKhqm3oe7vshuJYDS/index.html?_native_qwd=share&_native_p=4|22171&unionActId=31125&d=w3VEdGz&s=&cu=true&utm_source=kong&utm_medium=jingfen&utm_campaign=t_2010693212_&utm_term=6fdd8df4f0fd4db7a87511c7d178f0ab
...
function showCoupon(){
  {
    const t = getTs()
    let body = {"actId":"2HxATPMr9wQsKhqm3oe7vshuJYDS","unionActId":"31125","unpl":"V2_ZzNtbUVXRBxxX0UHLE1ZVWJXFlRLURdFdFoTVXJMXAQwUxpfclRCFnUUR1RnGlQUZwcZXUVcQBRFCEJkeBhcBGALEF5CVHMlfQAoVzYZMgYJAF8QD2dAFUUJdlR8GFUEZwsXWEZTQxNxDU5VfBlcDGczIl1EZ3MldDhHZHopF2tmThJaQ15CFX0NQ1B/GVoBYgsTWkJXShVFCkZUeB1sBg==","platform":3,"unionShareId":"","eid":"-1"}
    return new Promise(resolve => {
      $.get(taskPostUrlAPI('showCoupon',body), async (err, resp, data) => {
        try {
          if (err) {
            ...
            if (safeGet(data)) {
              ...
              console.log("getshow:"+data.msg+":"+data.data);
